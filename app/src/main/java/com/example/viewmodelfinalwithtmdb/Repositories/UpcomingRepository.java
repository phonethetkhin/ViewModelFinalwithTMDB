...
public class UpcomingRepository {
    public LiveData<MovieRespondModel> getmovielivedata()
    {
        ...
        Call<MovieRespondModel> movieRespondModelCall=apicalls.getUpComing("f17a830b443f5f3c5bcc8c13863083b1",1);
