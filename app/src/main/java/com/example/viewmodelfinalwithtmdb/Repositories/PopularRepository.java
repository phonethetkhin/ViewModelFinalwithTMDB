...
public class PopularRepository {
    public LiveData<MovieRespondModel> getPopularLiveData()
    {
        ...
        Call<MovieRespondModel> movieRespondModelCall=apicalls.getPopular("f17a830b443f5f3c5bcc8c13863083b1",1);
